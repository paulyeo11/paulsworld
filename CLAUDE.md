...
- **Trigger phrases — treat all the same way:** "check the IBKR folder in Drive", "update my IBKR raw data", and "update IBKR data". On any of these: look up the latest file(s) in that Drive folder via the Google Drive MCP tools, read the raw data, and update the relevant dashboard(s)/positions data from it (currently Table 29 = `options-breadboard.html`).
...
## Table 29 Options Dashboard — Standing Notes (added 2026-07-23)
