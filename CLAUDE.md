...
- **2026-07-31: META 4-leg IC — order staged, NOT filled.** Screenshot of a Tiger "Buy Order" ticket (Sep18'26 expiry, 49 DTE): Sell 505P / Buy 495P / Sell 600C / Buy 610C, $10 wings both sides. At time of screenshot (23:45): Mid −$4.47, Bid −$5.80 / Ask −$3.15 (spread $2.65, 84.1%). **Max Loss $689, Max Return $305, Breakevens 501.93 / 603.07.** Still sitting on the "Slide to Buy" screen — not confirmed filled, no Order ID/Exec ID yet. Live spot price and META's next earnings date not independently verified — check IV rank/earnings calendar on IBKR before sliding to confirm.
